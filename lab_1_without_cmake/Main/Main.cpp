...
int main() {
    Number a = createNumber(12.0);
    Number b = NUM_ONE;
    Number c = a + b;

    std::cout << "Number example: "
        << a.getValue() << " + " << b.getValue()
        << " = " << c.getValue() << std::endl;

    Vector v1(NUM_ONE, createNumber(2.0));
    Vector v2(createNumber(35.0), createNumber(2.0));
    ...
    std::cout << "Vector v1 = ("
        ...
        << std::endl;
    std::cout << "Vector v2 = ("
        << v2.getX().getValue() << ", " << v2.getY().getValue() << ")"
        << std::endl;
    std::cout << "v1 + v2 = ("
        << sum.getX().getValue() << ", " << sum.getY().getValue() << ")"
        << std::endl;
